...
description: "Notes from Bishop on fitting polynomials, overfitting, regularization, neurons, perceptrons, and backpropagation."
pubDate: 2025-09-14
---
...
We then need to choose the order for our polynomial. To do this, we choose different $M$ and see which one fits nicest to our data. We notice as we increase $M$, the function fits the data perfectly but does not resemble our target function ($\sin{(2\pi x)})$. 

*[Figure from original notes: Screenshot 2025-09-10 at 3.44.12 PM.png]*
...
*[Figure from original notes: Screenshot 2025-09-10 at 3.50.50 PM.png]*
...
Additionally, as the size of the test set increases, we see that our model generalizes much better and stops overfitting.

*[Figure from original notes: Screenshot 2025-09-10 at 5.04.52 PM.png]*
...
where the coefficient $\lambda$ determines the relative importance of the regularization term and $||\textbf{w}||^2=\textbf{w}^{\text{T}}\textbf{w}$ . 

*[Figure from original notes: Screenshot 2025-09-11 at 5.30.39 PM.png]*
...
*[Figure from original notes: Screenshot 2025-09-11 at 5.32.27 PM.png]*
...
*[Figure from original notes: Screenshot 2025-09-11 at 7.56.05 PM.png]*
